        ...
        <main className="landing">
            <div className="landing__background">
                <section className="landing__header">
                    ...
                    <h3 className="landing__header--sub">
                        De beste kapper in jouw buurt
                    </h3>
                </section>
                ...
                <section className="landing__buttons">
                    <button
                        className="landing__buttons--btn"
                ...
                <section className="landing__address">
                    ...
                    <a className="landing__address--tel" href="tel:0682307051">
                        {" "}
                        <FaPhone className="landing__address--tel-icon" /> 06 82
                        30 70 51
                    </a>
                    <a
                        className="landing__address--email"
                        href="mailto:ml.antczak@gmail.com"
                    >
                        {" "}
                        <FaEnvelope className="landing__address--email-icon" />
                        Stuur ons een email
                    </a>
                </section>
            </div>
            <section className="landing__open">
                ...
                <ul className="landing__open--list">
                    <li className="landing__open--list-item">
                        <span className="landing__open--list-item-day">
                            Maandag
                        </span>
                        <span className="landing__open--list-item-hour">
                            09:00 - 18:00
                        </span>
                    </li>
                    <li className="landing__open--list-item">
            ...
            <section className="landing__reviews">
                ...
                <div className="landing__reviews--opinion">
                    ...
                    <p className="landing__reviews--opinion-text">
                        Heel professioneel en klantvriendelijk. Tijdens het
                        wachten een lekker kopje koffie en een lekker muziekje.
                    </p>
            ...
            <section className="landing__story">
                <h3 className="landing__story--header">
                    Perfect Kapsel. Professionele Kappers.
                </h3>
